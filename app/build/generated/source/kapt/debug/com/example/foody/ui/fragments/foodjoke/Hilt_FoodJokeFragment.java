...
public abstract class Hilt_FoodJokeFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((FoodJokeFragment_GeneratedInjector) generatedComponent()).injectFoodJokeFragment(UnsafeCasts.<FoodJokeFragment>unsafeCast(this));
  }
